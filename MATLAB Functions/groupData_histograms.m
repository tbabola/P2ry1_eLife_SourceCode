function [stat, figh, counts] = groupData_histograms(paths)
     m = size(paths,1);
     rpks = [];
     lpks = [];
     rpks_tot = {};
...
%    
    figh = figure;
    h=barh(binY,Rcounts,.9,'FaceColor',lt_blue,'EdgeColor','white');
    hold on;
    barh(binY,-Lcounts,.9,'FaceColor',lt_org,'EdgeColor','white');
